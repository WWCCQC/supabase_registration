...
const CORRUPTED_TEXT_PATTERNS: { pattern: RegExp; correctName: string }[] = [
  ...
  // B075 - BKK : บางขุนเทียน_จอมทอง_บางบอน_ธนบุรี_คลองสาน_ราษฎร์บูรณะ_ทุ่งครุ (fix คลองสา → คลองสาน - ตัด น หายจาก encoding)
  { pattern: /บางขุนเทียน.*คลองสา[^น]/i, correctName: "BKK : บางขุนเทียน_จอมทอง_บางบอน_ธนบุรี_คลองสาน_ราษฎร์บูรณะ_ทุ่งครุ" },
];
