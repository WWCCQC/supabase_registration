...
const CORRUPTED_TEXT_PATTERNS: { pattern: RegExp; correctName: string }[] = [
  ...
  // B055 - BKK : มีนบุรี_คันนายาว_บึงกุ่ม (fix มีนบุ��ี / มีนบ���รี → มีนบุรี)
  { pattern: /มีนบ.{0,10}ี.*คันนายาว.*บึงกุ่ม|คันนายาว.*บึงกุ่ม/i, correctName: "BKK : มีนบุรี_คันนายาว_บึงกุ่ม" },
